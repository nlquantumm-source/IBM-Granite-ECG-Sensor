...
| :--- | :--- | :--- |
| **Polyphase Resampling** | $L' = L \times \frac{f'_s}{f_s}; \quad \text{Reconstruction via sinc interpolation:} \quad x(t) = \sum_{n} x[n] \cdot \text{sinc}(t - nT)$ | Downsamples ECG signals from 360 Hz to 250 Hz while preserving annotation timings;<br>Used in MIT-BIH loading (Cell 2). |
